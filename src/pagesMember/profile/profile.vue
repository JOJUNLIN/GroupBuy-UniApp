<script setup lang="ts">
	...
	const onSubmit = async () => {
		const { nickname, gender, email, account } = profile.value
		...
		// 更新Store信息
		memberStore.profile!.account = res.result.account
		memberStore.profile!.nickname = res.result.nickname
		memberStore.profile!.gender = res.result.gender
		memberStore.profile!.email = res.result.email
		...
		<view class="form">
			...
			<view class="form-content">
				<view class="form-item">
					...
					<input class="input" type="text" placeholder="请填写账号" v-model="profile!.account" />
				</view>
				<view class="form-item">
