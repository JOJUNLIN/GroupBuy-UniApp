<script setup lang="ts">
	...
	const onAddCart = async (ev : SkuPopupEvent) => {
		try {
			...
			// 创建一个新对象，将storage中的id和原有事件对象合并
			const eventWithStorageId = {
				...ev,
				userId // 添加storage中的id
			}

			// 传入合并后的对象
			await postMemberCartAPI(eventWithStorageId)
	...
	// const onAddCart = async (ev : SkuPopupEvent) => {
	// 	console.log(ev)
	// 	console.log("userId:"+memberStore.profile!.id)
	// }
